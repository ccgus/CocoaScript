...
@implementation COSResultSet
@synthesize query=_query;
@synthesize statement=_statement;

+ (instancetype)resultSetWithStatement:(COSStatement *)statement usingParentDatabase:(COSDatabase*)aDB {
    
    COSResultSet *rs = [[COSResultSet alloc] init];
...
- (void)setParentDB:(COSDatabase *)newDb {
    _parentDB = newDb;
}
